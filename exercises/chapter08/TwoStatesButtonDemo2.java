...
public class TwoStatesButtonDemo2 {
  JFrame frame = new JFrame("Two States Button");
    ...
    ItemListener il = new ItemListener(){
      public void itemStateChanged(ItemEvent e) {
        ...
        if(cb == cb1) {
          ...
          ta.append("\n JCheckBox Button2" + cb2.isSelected());
        } else if(cb == cb3) {
          ta.append("\n JCheckBox Button3" + cb3.isSelected());
        } else if(cb == cb4) {
          ta.append("\n JCheckBox Button4" + cb4.isSelected());
        } else if(cb == cb5) {
          ta.append("\n JCheckBox Button5" + cb5.isSelected());
        } else {
          ta.append("\n JCheckBox Button6" + cb6.isSelected());
        }
      }
    };
